...
dbus.Connection.prototype.getObject = function(destination, path, callback) {
  ...
  self.introspect(destination, path, function(introspection_data) {
    callback( new dbus.Proxy(path, introspection_data));
  });
}
